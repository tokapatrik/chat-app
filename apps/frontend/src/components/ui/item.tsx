...
function ItemDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-muted-foreground [&>a:hover]:text-primary line-clamp-2 text-left text-sm leading-normal font-normal whitespace-pre-wrap group-data-[size=xs]/item:text-xs [&>a]:underline [&>a]:underline-offset-4',
        className
      )}
      {...props}
    />
